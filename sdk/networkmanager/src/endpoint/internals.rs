...
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "networkmanager"
    .to_string().into());
    out.insert("signingRegion".to_string(), "us-west-2"
    .to_string().into());
    out
}),])
.build());
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://networkmanager.us-west-2.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://networkmanager.us-gov-west-1.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
