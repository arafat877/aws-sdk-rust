...
impl Client  {
    ...
    pub fn delete_data_protection_policy(&self) -> fluent_builders::DeleteDataProtectionPolicy {
                            fluent_builders::DeleteDataProtectionPolicy::new(self.handle.clone())
                        }
    ...
    ///   - [`limit(i32)`](crate::client::fluent_builders::DescribeDestinations::limit) / [`set_limit(Option<i32>)`](crate::client::fluent_builders::DescribeDestinations::set_limit): <p>The maximum number of items returned. If you don't specify a value, the default maximum value of 50 items is used.</p>
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::client::fluent_builders::DescribeLogGroups::into_paginator).
                        ///
                        /// - The fluent builder is configurable:
                        ///   - [`account_identifiers(Vec<String>)`](crate::client::fluent_builders::DescribeLogGroups::account_identifiers) / [`set_account_identifiers(Option<Vec<String>>)`](crate::client::fluent_builders::DescribeLogGroups::set_account_identifiers): <p>When <code>includeLinkedAccounts</code> is set to <code>True</code>, use this parameter to specify the list of accounts to search. You can specify as many as 20 account IDs in the array. </p>
    ///   - [`log_group_name_prefix(impl Into<String>)`](crate::client::fluent_builders::DescribeLogGroups::log_group_name_prefix) / [`set_log_group_name_prefix(Option<String>)`](crate::client::fluent_builders::DescribeLogGroups::set_log_group_name_prefix): <p>The prefix to match.</p> <note>   <p> <code>logGroupNamePrefix</code> and <code>logGroupNamePattern</code> are mutually exclusive. Only one of these parameters can be passed. </p>  </note>
    ///   - [`log_group_name_pattern(impl Into<String>)`](crate::client::fluent_builders::DescribeLogGroups::log_group_name_pattern) / [`set_log_group_name_pattern(Option<String>)`](crate::client::fluent_builders::DescribeLogGroups::set_log_group_name_pattern): <p>If you specify a string for this parameter, the operation returns only log groups that have names that match the string based on a case-sensitive substring search. For example, if you specify <code>Foo</code>, log groups named <code>FooBar</code>, <code>aws/Foo</code>, and <code>GroupFoo</code> would match, but <code>foo</code>, <code>F/o/o</code> and <code>Froo</code> would not match.</p> <note>   <p> <code>logGroupNamePattern</code> and <code>logGroupNamePrefix</code> are mutually exclusive. Only one of these parameters can be passed. </p>  </note>
    ...
    ///   - [`interleaved(bool)`](crate::client::fluent_builders::FilterLogEvents::interleaved) / [`set_interleaved(Option<bool>)`](crate::client::fluent_builders::FilterLogEvents::set_interleaved): <p>If the value is true, the operation attempts to provide responses that contain events from multiple log streams within the log group, interleaved in a single response. If the value is false, all the matched log events in the first log stream are searched first, then those in the next log stream, and so on.</p>  <p> <b>Important</b> As of June 17, 2019, this parameter is ignored and the value is assumed to be true. The response from this operation always interleaves events from multiple log streams within a log group.</p>
    ///   - [`unmask(bool)`](crate::client::fluent_builders::FilterLogEvents::unmask) / [`set_unmask(bool)`](crate::client::fluent_builders::FilterLogEvents::set_unmask): <p>Specify <code>true</code> to display the log event fields with all sensitive data unmasked and visible. The default is <code>false</code>.</p>  <p>To use this operation with this parameter, you must be signed into an account with the <code>logs:Unmask</code> permission.</p>
    ...
    ///   - [`next_backward_token(Option<String>)`](crate::output::GetLogEventsOutput::next_backward_token): <p>The token for the next set of items in the backward direction. The token expires after 24 hours. This token is not null. If you have reached the end of the stream, it returns the same token you passed in.</p>
    ...
    /// Constructs a fluent builder for the [`TagResource`](crate::client::fluent_builders::TagResource) operation.
                        ///
                        /// - The fluent builder is configurable:
                        ///   - [`resource_arn(impl Into<String>)`](crate::client::fluent_builders::TagResource::resource_arn) / [`set_resource_arn(Option<String>)`](crate::client::fluent_builders::TagResource::set_resource_arn): <p>The ARN of the resource that you're adding tags to.</p>  <p>The ARN format of a log group is <code>arn:aws:logs:<i>Region</i>:<i>account-id</i>:log-group:<i>log-group-name</i> </code> </p>  <p>The ARN format of a destination is <code>arn:aws:logs:<i>Region</i>:<i>account-id</i>:destination:<i>destination-name</i> </code> </p>  <p>For more information about ARN format, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/iam-access-control-overview-cwl.html">CloudWatch Logs resources and operations</a>.</p>
...
pub mod fluent_builders {
    ...
    impl AssociateKmsKey  {
        /// Creates a new `AssociateKmsKey`.
                                ...
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::AssociateKmsKey, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                pub async fn send(self) -> std::result::Result<crate::output::AssociateKmsKeyOutput, aws_smithy_http::result::SdkError<crate::error::AssociateKmsKeyError>>
                                 {
    ...
    impl CancelExportTask  {
        /// Creates a new `CancelExportTask`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::CancelExportTask, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::CancelExportTaskOutput, aws_smithy_http::result::SdkError<crate::error::CancelExportTaskError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl CreateExportTask  {
        /// Creates a new `CreateExportTask`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::CreateExportTask, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::CreateExportTaskOutput, aws_smithy_http::result::SdkError<crate::error::CreateExportTaskError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl CreateLogGroup  {
        /// Creates a new `CreateLogGroup`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::CreateLogGroup, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::CreateLogGroupOutput, aws_smithy_http::result::SdkError<crate::error::CreateLogGroupError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl CreateLogStream  {
        /// Creates a new `CreateLogStream`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::CreateLogStream, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::CreateLogStreamOutput, aws_smithy_http::result::SdkError<crate::error::CreateLogStreamError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    pub struct DeleteDataProtectionPolicy {
                            handle: std::sync::Arc<super::Handle>,
                            inner: crate::input::delete_data_protection_policy_input::Builder
                        }
    impl DeleteDataProtectionPolicy  {
        /// Creates a new `DeleteDataProtectionPolicy`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteDataProtectionPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                                    aws_smithy_http::result::SdkError<crate::error::DeleteDataProtectionPolicyError>
                                >  {
                                    let handle = self.handle.clone();
                                    let operation = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&handle.conf)
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteDataProtectionPolicyOutput, aws_smithy_http::result::SdkError<crate::error::DeleteDataProtectionPolicyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DeleteLogGroup  {
        /// Creates a new `DeleteLogGroup`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteLogGroup, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteLogGroupOutput, aws_smithy_http::result::SdkError<crate::error::DeleteLogGroupError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DeleteLogStream  {
        /// Creates a new `DeleteLogStream`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteLogStream, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteLogStreamOutput, aws_smithy_http::result::SdkError<crate::error::DeleteLogStreamError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DeleteMetricFilter  {
        /// Creates a new `DeleteMetricFilter`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteMetricFilter, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteMetricFilterOutput, aws_smithy_http::result::SdkError<crate::error::DeleteMetricFilterError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DeleteQueryDefinition  {
        /// Creates a new `DeleteQueryDefinition`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteQueryDefinition, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteQueryDefinitionOutput, aws_smithy_http::result::SdkError<crate::error::DeleteQueryDefinitionError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DeleteRetentionPolicy  {
        /// Creates a new `DeleteRetentionPolicy`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteRetentionPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteRetentionPolicyOutput, aws_smithy_http::result::SdkError<crate::error::DeleteRetentionPolicyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DeleteSubscriptionFilter  {
        /// Creates a new `DeleteSubscriptionFilter`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DeleteSubscriptionFilter, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DeleteSubscriptionFilterOutput, aws_smithy_http::result::SdkError<crate::error::DeleteSubscriptionFilterError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeDestinations  {
        /// Creates a new `DescribeDestinations`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeDestinations, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeDestinationsOutput, aws_smithy_http::result::SdkError<crate::error::DescribeDestinationsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeLogGroups  {
        /// Creates a new `DescribeLogGroups`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeLogGroups, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeLogGroupsOutput, aws_smithy_http::result::SdkError<crate::error::DescribeLogGroupsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeLogStreams  {
        /// Creates a new `DescribeLogStreams`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeLogStreams, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeLogStreamsOutput, aws_smithy_http::result::SdkError<crate::error::DescribeLogStreamsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeMetricFilters  {
        /// Creates a new `DescribeMetricFilters`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeMetricFilters, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeMetricFiltersOutput, aws_smithy_http::result::SdkError<crate::error::DescribeMetricFiltersError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeQueries  {
        /// Creates a new `DescribeQueries`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeQueries, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeQueriesOutput, aws_smithy_http::result::SdkError<crate::error::DescribeQueriesError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeQueryDefinitions  {
        /// Creates a new `DescribeQueryDefinitions`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeQueryDefinitions, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeQueryDefinitionsOutput, aws_smithy_http::result::SdkError<crate::error::DescribeQueryDefinitionsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeResourcePolicies  {
        /// Creates a new `DescribeResourcePolicies`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeResourcePolicies, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeResourcePoliciesOutput, aws_smithy_http::result::SdkError<crate::error::DescribeResourcePoliciesError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DescribeSubscriptionFilters  {
        /// Creates a new `DescribeSubscriptionFilters`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DescribeSubscriptionFilters, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DescribeSubscriptionFiltersOutput, aws_smithy_http::result::SdkError<crate::error::DescribeSubscriptionFiltersError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl DisassociateKmsKey  {
        /// Creates a new `DisassociateKmsKey`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::DisassociateKmsKey, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::DisassociateKmsKeyOutput, aws_smithy_http::result::SdkError<crate::error::DisassociateKmsKeyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl FilterLogEvents  {
        /// Creates a new `FilterLogEvents`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::FilterLogEvents, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::FilterLogEventsOutput, aws_smithy_http::result::SdkError<crate::error::FilterLogEventsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl GetDataProtectionPolicy  {
        /// Creates a new `GetDataProtectionPolicy`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::GetDataProtectionPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::GetDataProtectionPolicyOutput, aws_smithy_http::result::SdkError<crate::error::GetDataProtectionPolicyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl GetLogEvents  {
        /// Creates a new `GetLogEvents`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::GetLogEvents, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::GetLogEventsOutput, aws_smithy_http::result::SdkError<crate::error::GetLogEventsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl GetLogGroupFields  {
        /// Creates a new `GetLogGroupFields`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::GetLogGroupFields, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::GetLogGroupFieldsOutput, aws_smithy_http::result::SdkError<crate::error::GetLogGroupFieldsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl GetLogRecord  {
        /// Creates a new `GetLogRecord`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::GetLogRecord, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::GetLogRecordOutput, aws_smithy_http::result::SdkError<crate::error::GetLogRecordError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl ListTagsLogGroup  {
        /// Creates a new `ListTagsLogGroup`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::ListTagsLogGroup, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::ListTagsLogGroupOutput, aws_smithy_http::result::SdkError<crate::error::ListTagsLogGroupError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutDataProtectionPolicy  {
        /// Creates a new `PutDataProtectionPolicy`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutDataProtectionPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutDataProtectionPolicyOutput, aws_smithy_http::result::SdkError<crate::error::PutDataProtectionPolicyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutDestination  {
        /// Creates a new `PutDestination`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutDestination, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutDestinationOutput, aws_smithy_http::result::SdkError<crate::error::PutDestinationError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutDestinationPolicy  {
        /// Creates a new `PutDestinationPolicy`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutDestinationPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutDestinationPolicyOutput, aws_smithy_http::result::SdkError<crate::error::PutDestinationPolicyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutLogEvents  {
        /// Creates a new `PutLogEvents`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutLogEvents, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutLogEventsOutput, aws_smithy_http::result::SdkError<crate::error::PutLogEventsError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutMetricFilter  {
        /// Creates a new `PutMetricFilter`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutMetricFilter, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutMetricFilterOutput, aws_smithy_http::result::SdkError<crate::error::PutMetricFilterError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutQueryDefinition  {
        /// Creates a new `PutQueryDefinition`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutQueryDefinition, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutQueryDefinitionOutput, aws_smithy_http::result::SdkError<crate::error::PutQueryDefinitionError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutRetentionPolicy  {
        /// Creates a new `PutRetentionPolicy`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutRetentionPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutRetentionPolicyOutput, aws_smithy_http::result::SdkError<crate::error::PutRetentionPolicyError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl PutSubscriptionFilter  {
        /// Creates a new `PutSubscriptionFilter`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::PutSubscriptionFilter, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::PutSubscriptionFilterOutput, aws_smithy_http::result::SdkError<crate::error::PutSubscriptionFilterError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl StartQuery  {
        /// Creates a new `StartQuery`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::StartQuery, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::StartQueryOutput, aws_smithy_http::result::SdkError<crate::error::StartQueryError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl StopQuery  {
        /// Creates a new `StopQuery`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::StopQuery, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::StopQueryOutput, aws_smithy_http::result::SdkError<crate::error::StopQueryError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl TagLogGroup  {
        /// Creates a new `TagLogGroup`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::TagLogGroup, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::TagLogGroupOutput, aws_smithy_http::result::SdkError<crate::error::TagLogGroupError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    /// Fluent builder constructing a request to `TagResource`.
                        ///
    /// <p>Assigns one or more tags (key-value pairs) to the specified CloudWatch Logs resource. Currently, the only CloudWatch Logs resources that can be tagged are log groups and destinations. </p> 
    ...
    impl TestMetricFilter  {
        /// Creates a new `TestMetricFilter`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::TestMetricFilter, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::TestMetricFilterOutput, aws_smithy_http::result::SdkError<crate::error::TestMetricFilterError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
    ...
    impl UntagLogGroup  {
        /// Creates a new `UntagLogGroup`.
                                ...
                                /// sent. The operation's inner [http::Request] can be modified as well.
                                pub async fn customize(self) -> std::result::Result<
                                    crate::operation::customize::CustomizableOperation<crate::operation::UntagLogGroup, aws_http::retry::AwsResponseRetryClassifier,>,
                                ...
                                /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                                /// set when configuring the client.
                                pub async fn send(self) -> std::result::Result<crate::output::UntagLogGroupOutput, aws_smithy_http::result::SdkError<crate::error::UntagLogGroupError>>
                                 {
                                    let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                                        .make_operation(&self.handle.conf)
                                        .await
