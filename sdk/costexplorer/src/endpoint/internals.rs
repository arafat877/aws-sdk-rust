...
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "ce"
    .to_string().into());
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ce.us-east-1.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ce.cn-northwest-1.amazonaws.com.cn"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
