...
mod test {
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ca-central-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ca-central-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ca-central-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ca-central-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ca-central-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ca-central-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ca-central-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ca-central-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.eu-central-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.eu-central-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.eu-central-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.eu-central-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.eu-central-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.eu-central-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.eu-central-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.eu-central-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.us-west-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.us-west-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.us-west-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.us-west-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.us-west-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.us-west-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.us-west-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.us-west-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.eu-west-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.eu-west-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.eu-west-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.eu-west-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.eu-west-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.eu-west-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.eu-west-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.eu-west-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.eu-west-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.eu-west-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.eu-west-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.eu-west-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.eu-west-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.eu-west-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.eu-west-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.eu-west-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-northeast-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-northeast-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-northeast-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-northeast-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-northeast-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-northeast-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-northeast-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-northeast-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-northeast-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-northeast-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-northeast-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-northeast-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-northeast-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-northeast-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-northeast-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-northeast-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-southeast-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-southeast-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-southeast-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-southeast-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-southeast-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-southeast-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-southeast-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-southeast-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-southeast-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-southeast-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.ap-southeast-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.ap-southeast-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-southeast-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-southeast-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.ap-southeast-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.ap-southeast-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.us-east-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.us-east-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.us-east-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.us-east-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.us-east-1.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.us-east-1.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.us-east-1.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.us-east-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.us-east-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.us-east-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb-fips.us-east-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb-fips.us-east-2.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    let resolver = crate::endpoint::DefaultResolver::new();
                    let endpoint = resolver.resolve_endpoint(&params);
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.us-east-2.api.aws");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.us-east-2.api.aws")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://session.qldb.us-east-2.amazonaws.com");
                            assert_eq!(endpoint, aws_smithy_types::endpoint::Endpoint::builder().url("https://session.qldb.us-east-2.amazonaws.com")
    .build());
                }
