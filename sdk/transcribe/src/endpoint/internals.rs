...
if (region) == ("cn-north-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://cn.transcribe.cn-north-1.amazonaws.com.cn"
.to_string())
.build());
                            }
if (region) == ("cn-northwest-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://cn.transcribe.cn-northwest-1.amazonaws.com.cn"
.to_string())
.build());
                            }
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
