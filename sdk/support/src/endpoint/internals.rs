...
if (*use_fips) == (true) {
                                ...
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://support.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
...
if (region) == ("aws-global") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://support.us-east-1.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
    .to_string().into());
    out.insert("signingName".to_string(), "support"
    .to_string().into());
...
if (region) == ("aws-cn-global") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://support.cn-north-1.amazonaws.com.cn"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
...
if (region) == ("aws-iso-global") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://support.us-iso-east-1.c2s.ic.gov"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
...
if (region) == ("aws-iso-b-global") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://support.us-isob-east-1.sc2s.sgov.gov"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
