...
if (region) == ("dataplane-us-gov-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://greengrass-ats.iot.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("dataplane-us-gov-east-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://greengrass-ats.iot.us-gov-east-1.amazonaws.com"
.to_string())
.build());
                            }
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
