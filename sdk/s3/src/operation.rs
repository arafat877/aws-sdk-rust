...
mod create_multipart_upload_request_test {
    ...
    async fn create_multipart_upload_uri_construction_request() {
        ...
        aws_smithy_protocol_test::validate_query_string(&http_request, expected_query_params)
        );
    }
...
mod get_bucket_location_request_test {
    ...
    async fn get_bucket_location_response() {
        ...
        .set_location_constraint(
            Some(
                crate::model::BucketLocationConstraint::from("us-west-2")
            )
        )
        .build()
        ;
        ...
        pretty_assertions::assert_eq!(parsed.location_constraint, expected_output.location_constraint, "Unexpected value for `location_constraint`");
    }
...
impl aws_smithy_http::response::ParseHttpResponse for GetObjectTorrent {
                type Output = std::result::Result<crate::output::GetObjectTorrentOutput, crate::error::GetObjectTorrentError>;
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    // This is an error, defer to the non-streaming parser
                    if !response.http().status().is_success() && response.http().status().as_u16() != 200 {
                        return None;
...
mod head_bucket_request_test {
    ...
    async fn head_object_empty_body_response() {
        let expected_output =crate::error::NotFound::builder()
        .build()
        ;
        let http_response = http::response::Builder::new()
        ...
        .header("x-amz-id-2", "UTniwu6QmCIjVeuK2ZfeWBOnu7SqMQOS3Vac6B/K4H2ZCawYUl+nDbhGTImuyhZ5DFiojR3Kcz4=")
...
mod head_object_request_test {
    ...
    async fn head_object_uri_encoding_request() {
        ...
        pretty_assertions::assert_eq!(http_request.method(), "HEAD");
                        pretty_assertions::assert_eq!(http_request.uri().path(), "/test-bucket/%3C%3E%20%60%3F%F0%9F%90%B1");
    }
    /// This test case validates https://github.com/awslabs/smithy-rs/issues/456
    /// Test ID: HeadObjectEmptyBody
    #[tokio::test]
        ...
        .set_contents(
            Some(
                vec![
                    ...
                    .set_last_modified(
                        Some(
                            aws_smithy_types::DateTime::from_secs(1626452453)
                        )
                    )
                    .set_e_tag(
                        Some(
                    ...
                    .set_storage_class(
                        Some(
                            crate::model::ObjectStorageClass::from("STANDARD")
                        )
                    )
                    .build()
                    ,
                    ...
                    .set_last_modified(
                        Some(
                            aws_smithy_types::DateTime::from_secs(1626451330)
                        )
                    )
                    .set_e_tag(
                        Some(
        ...
        .set_lifecycle_configuration(
            Some(
                ...
                .set_rules(
                    Some(
                        vec![
                            crate::model::LifecycleRule::builder()
                            .set_expiration(
                                Some(
                            ...
                            .set_status(
                                Some(
                                    crate::model::ExpirationStatus::from("Enabled")
                                )
                            )
                            .set_id(
                                Some(
...
impl aws_smithy_http::response::ParseHttpResponse for SelectObjectContent {
                type Output = std::result::Result<crate::output::SelectObjectContentOutput, crate::error::SelectObjectContentError>;
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    // This is an error, defer to the non-streaming parser
                    if !response.http().status().is_success() && response.http().status().as_u16() != 200 {
                        return None;
