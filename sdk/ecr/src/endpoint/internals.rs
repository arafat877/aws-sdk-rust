...
if (*use_fips) == (true) {
                                ...
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ecr-fips.us-east-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("dkr-us-east-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ecr-fips.us-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("dkr-us-west-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ecr-fips.us-west-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("dkr-us-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ecr-fips.us-west-1.amazonaws.com"
.to_string())
.build());
                            }
...
if (region) == ("dkr-us-gov-east-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ecr-fips.us-gov-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("dkr-us-gov-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://ecr-fips.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
