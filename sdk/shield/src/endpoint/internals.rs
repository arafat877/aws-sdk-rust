...
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "shield"
    .to_string().into());
...
if (*use_fips) == (true) {
                                if (true) == (partition_result.supports_fips()) {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://shield-fips.us-east-1.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://shield.us-east-1.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
