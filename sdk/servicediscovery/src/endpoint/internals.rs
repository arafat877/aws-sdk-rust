...
if (*use_fips) == (true) {
                                ...
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://servicediscovery-fips.ca-central-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("servicediscovery") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://servicediscovery-fips.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
