...
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "health"
    .to_string().into());
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://global.health.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
...
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://global.health.amazonaws.com.cn"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
