...
if (*use_fips) == (true) {
                                ...
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://rds-fips.ca-central-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("rds.us-east-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://rds-fips.us-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("rds.us-east-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://rds-fips.us-east-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("rds.us-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://rds-fips.us-west-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("rds.us-west-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://rds-fips.us-west-2.amazonaws.com"
.to_string())
.build());
                            }
